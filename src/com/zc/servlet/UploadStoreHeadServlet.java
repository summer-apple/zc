...
@WebServlet("/UploadStoreHeadServlet")

public class UploadStoreHeadServlet extends HttpServlet {

	public UploadStoreHeadServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String fileDir = request.getSession().getServletContext().getRealPath("/images/store/head/");
...
System.out.println(extend);
					...
					if (extendboo) {
						...
						project_head_url = "images/store/head/"+adjunctname;
