...
public class UploadProjectHeadServlet extends HttpServlet {

	public UploadProjectHeadServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String fileDir = request.getSession().getServletContext().getRealPath("/images/project/head/");
...
System.out.println(extend);
					...
					if (extendboo) {
						...
						project_head_url = "images/project/head/"+adjunctname;
