...
jQuery.fn.pagination = function(maxentries, opts){
    ...
    return this.each(function() {
      ...
      //json 解析方法
        ...
        function getNewPage(current_page){
			 ...
			 var $limit = current_page;

			    $.ajax({
					type:"post",
					url:"GetSelectProjectServlet",
					data:{project_class:$project_class,project_state:$project_state,order_by:$order_by,limit:$limit},
					dataType: "json",
        ...
        function drawLinks() {
            ...
            var appendItem = function(page_id, appendopts){
                ...
                if(page_id == current_page){
                    ...
                    var lnk = jQuery("<li><a class='page-index-a'>"+(appendopts.text)+"</a></li>");
                    lnk.children().bind("click", getClickHandler(page_id))
                    //.attr('onclick','javascript:getNewPage();return false;')
